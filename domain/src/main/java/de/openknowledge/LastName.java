...
public class LastName extends AbstractSimpleValueObject<String> {
    ...
    @Override
    protected String validateAndNormalize(String initialValue) {
        isTrue(initialValue.matches("[A-ZÄÖU0-9][a-zäöüß0-9-]+"), "name must only contain letters");
        return super.validateAndNormalize(initialValue);
    }
}
